...
public class ViewMasa extends javax.swing.JFrame {
    ...
    ViewMasa(DaoImpl dao, Long selectedRow) {
        initComponents();
        this.dao = dao;
    ...
    private void initComponents() {
        ...
        addbtn.setFont(addbtn.getFont().deriveFont(addbtn.getFont().getSize()+67f));
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                .addGap(166, 166, 166)
                .addComponent(addbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 794, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
        try {
            ...
            switch (id) {
                case 1:
                    isAdded = dao.addSifarisMasa(selectedRow, (long) id);
                    if (isAdded) {
